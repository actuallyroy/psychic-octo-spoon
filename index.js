...
export function getCityNState(country){
    return {
        city: countryStatesNCapital[country].capital,
        state: countryStatesNCapital[country].states[Math.floor(Math.random()*countryStatesNCapital[country].states.length)]
    }
}
